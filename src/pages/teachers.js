...
import AddTeacherForm from "src/components/teacher/addTeacherForm"
import EditTeacherForm from "src/components/teacher/editTeacherForm"
...
const Teachers = () => {
	...
	const columns = [
		...
		},
		{
			...
			headerName: "Classes",
			flex: 1,
			valueGetter: (params) => params.value.map((item) => item.name).join(", "),
			valueFormatter: (params) => _.upperFirst(params.value),
		},
		{
			field: "Actions",
