...
//images
import image1 from 'public/assets/banners/comp-9.png';
import image2 from 'public/assets/banners/comp-10.png';
...
const RedLevel = () => {
  ...
  return (
    <MainContainer title="Red Level: Self Directed Learning">
      <Title>Red Level: Self Directed Learning</Title>
      ...
      <ol style={{ marginLeft: '20px' }}>
        <li>Practise your doubles, write your answers in your book or on a whiteboard:</li>
        <ColorBox
        ...
        ></ColorBox>
        <li>
          Next watch this video, about the 2 X strategy. Think about how doubles can help you. At the end, there are
          some questions for you to answer in your book or on a whiteboard.
        </li>
        ...
        <Grid container spacing={5} sx={{ marginBottom: '40px' }}>
          <Grid item xs={12} md={6}>
            <ColorBox btn bg={theme.palette.common.red} href="/online-practise/red-apprentice">
              <Typography variant="h4">Red Apprentice</Typography>
            </ColorBox>
          </Grid>
          <Grid item xs={12} md={6}>
            <ColorBox btn bg={theme.palette.common.red} href="/online-practise/red-master">
              <Typography variant="h4">Red Master</Typography>
            </ColorBox>
          </Grid>
        </Grid>
      </ol>
